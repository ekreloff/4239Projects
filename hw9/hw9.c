 ...
 * *******************************************************
 * Calls glut and gl functions to draw a sphere, and
...
int CreateShaderProgGeom()
{
    ...
    CreateShader(prog,GL_VERTEX_SHADER  ,"shader1.vert");
    //  OpenGL 3.2 adds layout ()
    CreateShader(prog,GL_GEOMETRY_SHADER_EXT,"shader1.geom");

    CreateShader(prog,GL_FRAGMENT_SHADER,"shader1.frag");
    //  Link program
    glLinkProgram(prog);
    //  Check for errors
