...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_Visual_t, stringdata) + ofs \
...
void Visual::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Visual *_t = static_cast<Visual *>(_o);
        switch (_id) {
        case 0: _t->setNumber((*reinterpret_cast< double(*)>(_a[1]))); break;
        default: ;
        }
    }
}

const QMetaObject Visual::staticMetaObject = {
    { &QGLWidget::staticMetaObject, qt_meta_stringdata_Visual.data,
      qt_meta_data_Visual,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Visual.stringdata))
        return static_cast<void*>(const_cast< Visual*>(this));
