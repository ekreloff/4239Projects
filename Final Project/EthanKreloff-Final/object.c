...
static char* readline(FILE* f)
{
   ...
   while ((ch = fgetc(f)) != EOF)
   {
      ...
      //  Pad character to line skipping gleading whitespace
...
//
static void readcoord(char* line,int n,float* x[],int* N1,int* M1)
{
